...
<br>
*Lottie的優點:*
那你應該會想問，為什麼不直接放gif的動畫就好?
Lottie除了呈現動畫外，
也可以透由程式去控制動畫的播放速度、轉換角度等效果，
甚至可以新增addListener事件抓到動畫的開始、結束點，做更多的應用。
而除了在動畫控制的自由度上，再來是文件大小的部分，
json檔案的大小比gif檔案小，且不會有邊緣鋸齒的狀況，性能當然也更好，
以及不會有畫質壓縮等等的問題。
<br>
*Lottie的缺點:*
1.如果設計師的Adobe After Effects建了很多圖層，
可能會造成json檔案文件大的問題。
2.Adobe After Effects某些動畫效果無法實現(像是描邊動畫等)
3.lottie其實在html上是svg、canvas動畫，若你想用自己程式寫動畫添加效果，
就無法利用lottie。
<br>
## lottie notes
*Html搭配lottie套件*<br>
